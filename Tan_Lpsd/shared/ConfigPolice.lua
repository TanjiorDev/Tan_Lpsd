...
ConfigPolice.PoliceStations = {
	...
	POLICE = {
		...
		Blip = {
			Coords  = vec3(441.700470,-982.220459,29.689667),
			Sprite  = 60,
			Display = 4,
			Scale   = 0.5,
			Colour  = 29,
...
ConfigPolice.Armurerie = {
    coords = vector3(453.842377,-980.034546,30.762121),  -- Exemple de coordonnées pour l'armurerie
    size = vector3(1, 1, 2),
    rotation = 0,
    Armory = {
...
ConfigPolice.Coffre = {
    PoliceCoffre = {
        coords      = vec3(445.057007, -974.739441, 31.052650),
        size        = vec3(1, 1, 1),
        rotation    = 0.0,
...
ConfigPolice.Saisies = {
    PoliceSaisies = {
        coords      = vec3(477.694489, -984.071350, 25.195333),
        size        = vec3(1, 1, 1),
        rotation    = 0.0,
...
--Vestiaire 
ConfigPolice.VestiaireCoords = vector3(457.098297,-993.958130,31.005070) -- Coordonnées du vestiaire
...
ConfigPolice.NPCs = {
    ...
    {
        model = "s_m_y_cop_01",
        coords =  vector4(459.31, -1007.97, 28.26, 84.78),
        freeze = true,
        invincible = true,
        text = "👋 Ouvrir le Garage police"
    },
